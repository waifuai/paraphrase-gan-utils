...
def test_openrouter_post_success(mock_post, monkeypatch):
    ...
    out = post_chat_completion("openrouter/free", "Paraphrase the following sentence: x")
...
def test_openrouter_post_non_200(mock_post, monkeypatch):
    ...
    out = post_chat_completion("openrouter/free", "hello")
    assert out is None
...
def test_openrouter_classify_normalization(mock_post, monkeypatch):
    ...
    out = classify_with_openrouter("example", "openrouter/free")
    assert out == "1"
